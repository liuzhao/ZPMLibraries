...
@property (nonatomic, strong) ZPMDebugOverlay *zpmWindow;
...
- (void)didmissConsoleWindow
{
    [self closeNSLogToDocumentFolder];
    [self.zpmWindow dissmissWindow];
}
...
- (void)showDebugOverlay
{
    if (!self.zpmWindow) {
        ...
        self.zpmWindow = zpmWindow;
    }
    [self.zpmWindow showWindow];
}
