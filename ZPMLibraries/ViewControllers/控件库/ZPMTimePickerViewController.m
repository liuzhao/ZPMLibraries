...
@interface ZPMTimePickerViewController ()

@end

@implementation ZPMTimePickerViewController
...
- (void)viewDidLoad {
    ...
    for (NSInteger i = 0; i < arr.count; i++) {
        ...
        selectBtn.frame = CGRectMake(20, 64 + 40 + 50 * i, self.view.frame.size.width - 40, 40);
        selectBtn.tag = i;
